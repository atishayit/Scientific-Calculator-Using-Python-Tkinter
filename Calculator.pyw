...
class Calculator:
    def __init__(self, master):
        ...
        my_item = tk.Label(top_frame, text="Scientific Calculator",
                           font=('times new roman', 14, 'bold'), fg='white', width=26, bg='#666666')
        my_item.pack()

        # entry interface for inputs
        txt_display = tk.Entry(top_frame, font=('calculator', 36), relief='flat',
                               bg='light green', fg='black', textvariable=self.text_input, width=60, bd=4, justify='right')
        txt_display.pack()
#--------------------------------------------------------------------------------------------------------------------------------------------
        # row 0
        # left bracket button
...
#-------------------------------------------------------------------------------------------------------------------------------------------
        ...
        self.btn_eq.configure(bg='light green', activebackground='#ff9980')
